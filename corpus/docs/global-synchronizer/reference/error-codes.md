...
> Operator reference for Canton error codes, log-level meanings, and error categories
...
Every error on the API is constructed to allow automated and manual error handling. First, the error category maps to exactly one gRPC status code. Second, every [error description](https://grpc.github.io/grpc-java/javadoc/io/grpc/Status.html#getDescription--) (of the corresponding `StatusRuntimeException.Status`) starts with the error information (**SOMETHING\_NOT\_SO\_GOOD\_HAPPENED(CN,x)**), separated from a human readable description by a colon (":"). The rest of the description is targeted to humans and should never be parsed by applications, as the description might change in future releases to improve clarity.
...
Generally, automated error handling can be done on any level (e.g. load balancer using gRPC status codes, application using `ErrorCategory` or human reacting to error IDs). In most cases it is advisable to deal with errors on a per-category basis and deal with error IDs in very specific situations which are application-dependent. For example, a command failure with the message "CONTRACT\_NOT\_FOUND" may be an application failure in case the given application is the only actor on the contracts, whereas a "CONTRACT\_NOT\_FOUND" message is to be expected in a case where multiple independent actors operate on the ledger state.
...
#### INTERNAL\_AUTHORIZATION\_ERROR
...
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status INVALID\_ARGUMENT including a detailed error message.
...
* **Conveyance**: This error is logged with log-level WARN on the server side. It is exposed on the API with grpc-status PERMISSION\_DENIED without any details for security reasons.

#### STALE\_STREAM\_AUTHORIZATION
...
* **Conveyance**: This error is logged with log-level WARN on the server side. It is exposed on the API with grpc-status INVALID\_ARGUMENT without any details for security reasons.
...
#### ACS\_COMMITMENT\_DEGRADATION\_WITH\_INEFFECTIVE\_CONFIG
...
#### ADD\_PARTY\_DISCONNECTED\_FROM\_SYNCHRONIZER
...
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.
...
#### DISCLOSED\_CONTRACTS\_SYNCHRONIZER\_ID\_MISMATCH
...
#### FAILED\_TO\_DETERMINE\_LEDGER\_TIME
...
#### FAILED\_TO\_EXECUTE\_TRANSACTION
...
#### FAILED\_TO\_PREPARE\_TRANSACTION
...
#### INTERPRETATION\_TIME\_EXCEEDED
...
#### PACKAGE\_NAME\_DISCARDED\_DUE\_TO\_UNVETTED\_PACKAGES
...
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status NOT\_FOUND including a detailed error message.
...
#### PRESCRIBED\_SYNCHRONIZER\_ID\_MISMATCH
...
#### COMMAND\_PREPROCESSING\_FAILED
...
#### CONTRACT\_DOES\_NOT\_IMPLEMENT\_INTERFACE
...
#### CONTRACT\_DOES\_NOT\_IMPLEMENT\_REQUIRING\_INTERFACE
...
#### CONTRACT\_ID\_IN\_CONTRACT\_KEY
...
#### CREATE\_EMPTY\_CONTRACT\_KEY\_MAINTAINERS
...
#### DISCLOSED\_CONTRACT\_KEY\_HASHING\_ERROR
...
#### FETCH\_EMPTY\_CONTRACT\_KEY\_MAINTAINERS
...
#### TEMPLATE\_PRECONDITION\_VIOLATED
...
#### INTERPRETATION\_CRYPTO\_ERROR\_MALFORMED\_BYTE\_ENCODING
...
#### INTERPRETATION\_CRYPTO\_ERROR\_MALFORMED\_KEY
...
#### INTERPRETATION\_CRYPTO\_ERROR\_MALFORMED\_SIGNATURE
...
#### INTERPRETATION\_UPGRADE\_ERROR\_AUTHENTICATION\_FAILED
...
#### INTERPRETATION\_UPGRADE\_ERROR\_TRANSLATION\_FAILED
...
#### INTERPRETATION\_UPGRADE\_ERROR\_VALIDATION\_FAILED
...
#### CONCURRENT\_PARTY\_DETAILS\_UPDATE\_DETECTED
...
#### INTERNAL\_PARTY\_RECORD\_ALREADY\_EXISTS
...
#### INTERNAL\_PARTY\_RECORD\_NOT\_FOUND
...
#### INVALID\_PARTY\_DETAILS\_UPDATE\_REQUEST
...
#### MAX\_PARTY\_DETAILS\_ANNOTATIONS\_SIZE\_EXCEEDED
...
#### CONCURRENT\_USER\_UPDATE\_DETECTED
...
#### INVALID\_USER\_UPDATE\_REQUEST
...
#### MAX\_USER\_ANNOTATIONS\_SIZE\_EXCEEDED
...
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status ALREADY\_EXISTS including a detailed error message.

#### USER\_DELETED\_WHILE\_UPDATING
...
#### IDP\_CONFIG\_ISSUER\_ALREADY\_EXISTS
...
#### INVALID\_IDENTITY\_PROVIDER\_UPDATE\_REQUEST
...
#### TOO\_MANY\_IDENTITY\_PROVIDER\_CONFIGS
...
#### CONFIGURATION\_ENTRY\_REJECTED
...
#### DISCLOSED\_CONTRACTS\_CONFLICTING\_PAYLOADS
...
#### INVALID\_DEDUPLICATION\_PERIOD
...
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status OUT\_OF\_RANGE including a detailed error message.

#### OFFSET\_OUT\_OF\_RANGE
...
#### PARTICIPANT\_DATA\_ACCESSED\_AFTER\_LEDGER\_END
...
#### PARTICIPANT\_PRUNED\_DATA\_ACCESSED
...
#### NO\_INTERFACE\_FOR\_PACKAGE\_NAME\_AND\_QUALIFIED\_NAME
...
#### NO\_TEMPLATES\_FOR\_PACKAGE\_NAME\_AND\_QUALIFIED\_NAME
...
#### TEMPLATES\_OR\_INTERFACES\_NOT\_FOUND
...
#### SUBMISSION\_ALREADY\_IN\_FLIGHT
...
#### PACKAGE\_SERVICE\_INTERNAL\_ERROR
...
#### MAIN\_PACKAGE\_IN\_DAR\_DOES\_NOT\_MATCH\_EXPECTED
...
#### SUBMITTER\_CANNOT\_ACT\_VIA\_PARTICIPANT
...
#### SUBMITTING\_PARTY\_NOT\_KNOWN\_ON\_LEDGER
...
#### INTERNALLY\_INCONSISTENT\_KEYS
...
#### JSON\_API\_MAXIMUM\_LIST\_ELEMENTS\_NUMBER\_REACHED
...
#### PACKAGE\_OR\_DAR\_REMOVAL\_ERROR

* **Explanation**: Errors raised by the Package Service on package removal.
* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### PACKAGE\_SERVICE\_CANNOT\_AUTODETECT\_SYNCHRONIZER
...
#### PACKAGE\_SERVICE\_NOT\_CONNECTED\_TO\_SYNCHRONIZER
...
#### UNRESOLVED\_VETTING\_REFERENCE
...
#### INCONSISTENT\_REASSIGNMENT\_ID
...
* **Conveyance**: This error is logged with log-level ERROR on the server side and exposed on the API with grpc-status INVALID\_ARGUMENT including a detailed error message.

#### REASSIGNMENT\_VALIDATION\_FAILED
...
#### LOCAL\_VERDICT\_BAD\_ROOT\_HASH\_MESSAGES
...
#### LOCAL\_VERDICT\_CREATES\_EXISTING\_CONTRACTS
...
#### LOCAL\_VERDICT\_FAILED\_MODEL\_CONFORMANCE\_CHECK
...
#### LOCAL\_VERDICT\_MALFORMED\_PAYLOAD
...
#### LOCAL\_VERDICT\_MALFORMED\_REQUEST
...
#### LOCAL\_VERDICT\_INACTIVE\_CONTRACTS
...
#### LOCAL\_VERDICT\_LOCKED\_CONTRACTS
...
#### LOCAL\_VERDICT\_LEDGER\_TIME\_OUT\_OF\_BOUND
...
#### LOCAL\_VERDICT\_PREPARATION\_TIME\_OUT\_OF\_BOUND
...
#### UNASSIGNMENT\_ACTIVENESS\_CHECK\_FAILED
...
#### AUTOMATIC\_REASSIGNMENT\_FOR\_TRANSACTION\_FAILED
...
#### UNABLE\_TO\_GET\_STATIC\_PARAMETERS
...
#### UNABLE\_TO\_GET\_TOPOLOGY\_SNAPSHOT
...
#### DISCLOSED\_CONTRACT\_AUTHENTICATION\_FAILED
...
#### NOT\_CONNECTED\_TO\_ALL\_CONTRACT\_SYNCHRONIZERS
...
#### NO\_SYNCHRONIZER\_FOR\_SUBMISSION
...
#### NO\_SYNCHRONIZER\_ON\_WHICH\_ALL\_SUBMITTERS\_CAN\_SUBMIT
...
#### SUBMITTER\_ALWAYS\_STAKEHOLDER
...
#### UNKNOWN\_CONTRACT\_SYNCHRONIZERS
...
#### INVALID\_PRESCRIBED\_SYNCHRONIZER\_ID

* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### SUBMISSION\_SYNCHRONIZER\_NOT\_READY
...
#### CANNOT\_PERFORM\_ALL\_VALIDATIONS
...
#### CHOSEN\_MEDIATOR\_IS\_INACTIVE
...
#### CONTRACT\_AUTHENTICATION\_FAILED
...
#### INVALID\_EXTERNAL\_TRANSACTION
...
#### NO\_VIEW\_WITH\_VALID\_RECIPIENTS
...
#### PACKAGE\_NOT\_VETTED\_BY\_RECIPIENTS
...
#### PARTICIPANT\_OVERLOADED

* **Explanation**: The participant has rejected all incoming commands during a configurable grace period.
* **Resolution**: Configure more restrictive resource limits. Change applications to submit commands at a lower rate. Configure a higher value for <span class="title-ref">myParticipant.parameters.warnIfOverloadedFor</span>.
* **Category**: ContentionOnSharedResources
* **Conveyance**: This error is logged with log-level WARN on the server side and exposed on the API with grpc-status ABORTED including a detailed error message.

#### SEQUENCER\_BACKPRESSURE
...
#### SYNCHRONIZER\_WITHOUT\_MEDIATOR
...
#### UNKNOWN\_CONTRACT\_SYNCHRONIZER
...
#### NOT\_CONNECTED\_TO\_ANY\_SYNCHRONIZER
...
#### NOT\_CONNECTED\_TO\_SYNCHRONIZER
...
#### INVALID\_ARGUMENT\_SYNC\_SERVICE

* **Category**: InvalidIndependentOfSystemState
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status INVALID\_ARGUMENT including a detailed error message.

#### PARTY\_ALLOCATION\_CANNOT\_DETERMINE\_SYNCHRONIZER
...
#### PARTY\_ALLOCATION\_WITHOUT\_CONNECTED\_SYNCHRONIZER
...
#### SYNC\_SERVICE\_ALIAS\_RESOLUTION
...
#### SYNC\_SERVICE\_BAD\_CONNECTIVITY
...
#### SYNC\_SERVICE\_BECAME\_PASSIVE
...
#### SYNC\_SERVICE\_INTERNAL\_ERROR
...
#### SYNC\_SERVICE\_PASSIVE\_REPLICA
...
#### SYNC\_SERVICE\_PHYSICAL\_ID\_REGISTRATION
...
#### SYNC\_SERVICE\_SYNCHRONIZERS\_MUST\_BE\_OFFLINE
...
#### SYNC\_SERVICE\_SYNCHRONIZER\_DISABLED\_US
...
* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level WARN on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### SYNC\_SERVICE\_SYNCHRONIZER\_DISCONNECTED
...
#### SYNC\_SERVICE\_SYNCHRONIZER\_MUST\_NOT\_HAVE\_IN\_FLIGHT\_TRANSACTIONS
...
#### SYNC\_SERVICE\_UNKNOWN\_SYNCHRONIZER
...
#### BROKEN\_SYNCHRONIZER\_MIGRATION

* **Category**: SystemInternalAssumptionViolated
* **Conveyance**: This error is logged with log-level ERROR on the server side. It is exposed on the API with grpc-status INTERNAL without any details for security reasons.

#### INVALID\_SYNCHRONIZER\_MIGRATION\_REQUEST
...
#### SYNCHRONIZER\_REGISTRY\_INTERNAL\_ERROR
...
#### CANNOT\_ISSUE\_SYNCHRONIZER\_TRUST\_CERTIFICATE
...
#### MISCONFIGURED\_STATIC\_SYNCHRONIZER\_PARAMETERS
...
#### SEQUENCERS\_FROM\_DIFFERENT\_SYNCHRONIZERS\_ARE\_CONFIGURED
...
#### SYNCHRONIZER\_PARAMETERS\_CHANGED
...
#### FAILED\_TO\_CONNECT\_TO\_SEQUENCER
...
#### FAILED\_TO\_CONNECT\_TO\_SEQUENCERS
...
#### SYNCHRONIZER\_IS\_NOT\_AVAILABLE
...
#### SYNCHRONIZER\_ALIAS\_DUPLICATION
...
#### SYNCHRONIZER\_CRYPTO\_HANDSHAKE\_FAILED
...
#### SYNCHRONIZER\_HANDSHAKE\_FAILED
...
#### CAN\_NOT\_AUTOMATICALLY\_VET\_ADMIN\_WORKFLOW\_PACKAGE
...
#### CONTRACT\_ASSIGNATION\_CHANGE\_ERROR
...
#### CONTRACT\_SERIALIZATION\_ERROR
...
#### INVALID\_ACS\_SNAPSHOT\_TIMESTAMP
...
#### INVALID\_ARGUMENT\_REPAIR

* **Category**: InvalidIndependentOfSystemState
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status INVALID\_ARGUMENT including a detailed error message.

#### INVALID\_STATE\_REPAIR\_ERROR

* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### IO\_STREAM\_REPAIR\_ERROR

* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### MANUAL\_LOGICAL\_SYNCHRONIZER\_UPGRADE\_ERROR
...
#### NO\_PREFERRED\_PACKAGES\_FOUND
...
#### NO\_VETTED\_INTERFACE\_IMPLEMENTATION\_PACKAGE
...
#### ILLEGAL\_ARGUMENT\_PRUNING\_ERROR
...
#### SHUTDOWN\_INTERRUPTED\_PRUNING
...
* **Resolution**: Specify a lower offset or retry pruning after a while. Generally, you can only prune older events. In particular, the events must be older than the sum of mediator reaction timeout and participant timeout for every synchronizer. And, you can only prune events that are older than the deduplication time configured for this participant. Therefore, if you observe this error, you either just prune older events or you adjust the settings for this participant. The error details field <span class="title-ref">safe\_offset</span> contains the highest offset that can currently be pruned, if any.
* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.
...
#### INDEX\_DB\_SQL\_NON\_TRANSIENT\_ERROR
...
#### INDEX\_DB\_SQL\_TRANSIENT\_ERROR
...
#### INVALID\_ARGUMENT\_PARTY\_MANAGEMENT\_ERROR

* **Category**: InvalidIndependentOfSystemState
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status INVALID\_ARGUMENT including a detailed error message.

#### INVALID\_STATE\_PARTY\_MANAGEMENT\_ERROR

* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### INVALID\_TIMESTAMP\_PARTY\_MANAGEMENT\_ERROR
...
#### PARTICIPANT\_INSPECTION\_ILLEGAL\_ARGUMENT\_ERROR
...
#### PARTICIPANT\_INSPECTION\_INTERNAL\_ERROR
...
#### PARTICIPANT\_REPLICATION\_INTERNAL\_ERROR
...
#### PARTICIPANT\_REPLICATION\_NOT\_SUPPORTED\_BY\_STORAGE
...
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status DEADLINE\_EXCEEDED including a detailed error message.
...
#### INVALID\_ACKNOWLEDGEMENT\_SIGNATURE
...
#### INVALID\_ACKNOWLEDGEMENT\_TIMESTAMP
...
#### INVALID\_SUBMISSION\_REQUEST\_SIGNATURE
...
#### MAX\_SEQUENCING\_TIME\_EXCEEDED
...
#### MULTIPLE\_MEDIATOR\_RECIPIENTS
...
#### PAYLOAD\_TO\_EVENT\_TIME\_BOUND\_EXCEEDED
...
#### SEQUENCED\_BEFORE\_OR\_AT\_LOWER\_BOUND
...
#### CANNOT\_DISABLE\_LOCAL\_SEQUENCER\_MEMBER
...
* **Resolution**: Disabling sequencer subscriptions is typically done to facilitate sequencer pruning. If the sequencer's local subscription prevents sequencer pruning, consider lowering the sequencer time tracker <span class="title-ref">min\_observation\_duration</span>.
* **Category**: InvalidIndependentOfSystemState
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status INVALID\_ARGUMENT including a detailed error message.

### 6. ConfigErrors

#### CANNOT\_PARSE\_CONFIG\_FILES
...
#### TOPOLOGY\_CANNOT\_REMOVE\_MAPPING
...
#### TOPOLOGY\_CONFIRMING\_THRESHOLD\_CANNOT\_BE\_REACHED
...
#### TOPOLOGY\_DANGEROUS\_COMMAND\_REQUIRES\_FORCE\_ALIEN\_MEMBER
...
#### TOPOLOGY\_ILLEGAL\_REMOVAL\_OF\_ACTIVE\_TRANSACTIONS
...
#### TOPOLOGY\_INCONSISTENT\_SNAPSHOT
...
#### TOPOLOGY\_INCREASE\_OF\_PREPARATION\_TIME\_TOLERANCE
...
#### TOPOLOGY\_INVALID\_OWNER\_TO\_KEY\_MAPPING
...
#### TOPOLOGY\_INVALID\_REMOVAL\_OF\_OWNER\_TO\_KEY\_MAPPING
...
#### TOPOLOGY\_INVALID\_SYNCHRONIZER
...
#### TOPOLOGY\_INVALID\_TX\_SIGNATURE
...
#### TOPOLOGY\_INVALID\_UPGRADE\_TIME
...
#### TOPOLOGY\_MANAGER\_INTERNAL\_ERROR
...
#### TOPOLOGY\_MAPPING\_ALREADY\_EXISTS
...
#### TOPOLOGY\_MEDIATORS\_ALREADY\_IN\_OTHER\_GROUPS
...
#### TOPOLOGY\_MEMBER\_CANNOT\_REJOIN\_SYNCHRONIZER

* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### TOPOLOGY\_MISSING\_MAPPING

* **Category**: InvalidGivenCurrentSystemStateResourceMissing
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status NOT\_FOUND including a detailed error message.

#### TOPOLOGY\_MULTI\_TRANSACTION\_HASH\_MISMATCH
...
#### TOPOLOGY\_NAMESPACE\_ALREADY\_IN\_USE
...
#### TOPOLOGY\_NAMESPACE\_HAS\_BEEN\_REVOKED
...
#### TOPOLOGY\_NO\_APPROPRIATE\_SIGNING\_KEY\_IN\_STORE
...
#### TOPOLOGY\_NO\_CORRESPONDING\_ACTIVE\_TX\_TO\_REVOKE
...
#### TOPOLOGY\_NO\_ONGOING\_SYNCHRONIZER\_UPGRADE
...
#### TOPOLOGY\_ONGOING\_SYNCHRONIZER\_UPGRADE
...
#### TOPOLOGY\_PARTICIPANT\_ID\_CONFLICT\_WITH\_PARTY
...
#### TOPOLOGY\_PARTICIPANT\_ONBOARDING\_REFUSED
...
#### TOPOLOGY\_PARTY\_ID\_CONFLICT\_WITH\_ADMIN\_PARTY
...
#### TOPOLOGY\_REMOVE\_MUST\_NOT\_CHANGE\_MAPPING
...
#### TOPOLOGY\_SECRET\_KEY\_NOT\_IN\_STORE
...
#### TOPOLOGY\_SERIAL\_MISMATCH

* **Category**: InvalidGivenCurrentSystemStateOther
* **Conveyance**: This error is logged with log-level INFO on the server side and exposed on the API with grpc-status FAILED\_PRECONDITION including a detailed error message.

#### TOPOLOGY\_SIGNING\_THRESHOLD\_CANNOT\_BE\_REACHED
...
#### TOPOLOGY\_TEMPORARY\_STORE\_ALREADY\_EXISTS
...
#### TOPOLOGY\_TOO\_MANY\_PENDING\_TOPOLOGY\_TRANSACTIONS
...
#### TOPOLOGY\_TOO\_MANY\_TRANSACTION\_WITH\_HASH
...
#### TOPOLOGY\_TRANSACTION\_NOT\_FOUND
...
#### TOPOLOGY\_UNAUTHORIZED\_TRANSACTION
...
#### TOPOLOGY\_VALUE\_OUT\_OF\_BOUNDS
...
#### SYNCHRONIZER\_NODE\_INITIALISATION\_FAILED
...
#### CLIENT\_AUTHENTICATION\_FAULTY
...
#### CLIENT\_AUTHENTICATION\_REJECTED
...
#### EXTERNAL\_PARTY\_ALREADY\_EXISTS
...
#### TOPOLOGY\_CANNOT\_VET\_DUE\_TO\_MISSING\_PACKAGES
...
#### TOPOLOGY\_DEPENDENCIES\_NOT\_VETTED
...
#### TOPOLOGY\_DISABLE\_PARTY\_WITH\_ACTIVE\_CONTRACTS
...
#### TOPOLOGY\_INSUFFICIENT\_PERMISSION\_FOR\_SIGNATORY\_PARTY
...
#### TOPOLOGY\_INSUFFICIENT\_SIGNATORY\_ASSIGNING\_PARTICIPANTS
...
#### CONSOLE\_COMMAND\_INTERNAL\_ERROR

* **Category**: SystemInternalAssumptionViolated
* **Conveyance**: These errors are shown as errors on the console.

#### CONSOLE\_COMMAND\_TIMED\_OUT
...
#### DUPLICATE\_CONFIRMATION\_REQUEST\_UUID
...
#### MEDIATOR\_PARTICIPANT\_EQUIVOCATION
...
#### MEDIATOR\_RECEIVED\_MALFORMED\_MESSAGE
...
#### ENCRYPTION\_KEY\_CREATION\_ERROR
...
#### ENCRYPTION\_KEY\_GENERATION\_ERROR
...
#### INCONSISTENT\_SIGNATURE\_CHECK\_ALARM
...
#### NO\_ENCRYPTED\_PRIVATE\_KEY\_STORE\_ERROR
...
#### REGISTER\_KMS\_KEY\_INTERNAL\_ERROR
...
#### WRAPPER\_KEY\_DISABLED\_OR\_DELETED\_ERROR
...
#### INVALID\_TRAFFIC\_CONTROL\_PURCHASED\_MESSAGE
...
#### TRAFFIC\_CONTROL\_SERIAL\_TOO\_LOW
...
#### TRAFFIC\_CONTROL\_STATE\_NOT\_FOUND
...
#### TRAFFIC\_CONTROL\_TOP\_UP\_SUBMISSION\_FAILED
...
#### SEQUENCER\_AGGREGATE\_SUBMISSION\_ALREADY\_SENT
...
#### SEQUENCER\_AGGREGATE\_SUBMISSION\_STUFFING
...
#### SEQUENCER\_MAX\_SEQUENCING\_TIME\_TOO\_FAR
...
#### SEQUENCER\_NOT\_ENOUGH\_TRAFFIC\_CREDIT
...
#### SEQUENCER\_SUBMISSION\_REQUEST\_MALFORMED
...
* **Category**: UnredactedSecurityAlert
* **Conveyance**: This error is logged with log-level WARN on the server side and exposed on the API with grpc-status INVALID\_ARGUMENT including a detailed error message.

#### SEQUENCER\_SUBMISSION\_REQUEST\_REFUSED
...
#### SEQUENCER\_TOMBSTONE\_PERSISTED
...
#### SEQUENCER\_TOPOLOGY\_TIMESTAMP\_AFTER\_SEQUENCING\_TIMESTAMP
...
#### SEQUENCER\_TOPOLOGY\_TIMESTAMP\_TOO\_EARLY
...
#### SEQUENCER\_UNKNOWN\_RECIPIENTS
...
#### PROTO\_DESERIALIZATION\_FAILURE
...
#### SEQUENCER\_SEND\_ASYNC\_CLIENT\_ERROR
...
#### SEQUENCER\_TOMBSTONE\_ENCOUNTERED
...
#### SIGNING\_KEY\_GENERATION\_ERROR
...
#### SYSTEM\_CLOCK\_RUNNING\_BACKWARDS
