...
> Configure Canton nodes using HOCON files, command-line options, and declarative configuration
...
# Configure Canton with PostgreSQL<span id="postgres-config" />
