...
> Moving your Canton application from LocalNet through DevNet, TestNet, and into MainNet production
...
Type 3 upgrades involve fundamental changes to the Canton synchronization protocol. These protocol upgrades are performed through a Logical Synchronizer Upgrade (LSU) and occur every three to four months.
