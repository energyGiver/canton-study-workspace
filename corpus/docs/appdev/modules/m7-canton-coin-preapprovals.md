...
> How TransferPreapproval contracts enable preapproved Canton Coin transfers
...
Note the [limit on the number of parties](/global-synchronizer/production-operations/scalability) when setting up preapprovals with the provider set as the validator operator.
