...
source_id: "SRC-73A0AD4B8B"
source_path: "reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/identityproviderconfigservice/getidentityproviderconfig"
source_commit: "5ce61f7ca8ec6ad9af3d5e19db3583588ba49d65"
source_sha256: "bcd02e3bdbceb129162815783dcf8df262380b95412f45c5f40055056fa73b8f"
...
<Warning>
  이 페이지는 팀 리서치를 위한 비공식 한글 번역입니다. 기술적 판단에는 [공식 영어 원문](https://docs.canton.network/reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/identityproviderconfigservice/getidentityproviderconfig.md)을 사용하세요.
</Warning>
