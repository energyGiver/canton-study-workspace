...
source_id: "SRC-21F6CAF5B7"
source_path: "reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/identityproviderconfigservice/updateidentityproviderconfig"
source_commit: "5ce61f7ca8ec6ad9af3d5e19db3583588ba49d65"
source_sha256: "def5f202ad5deef01f05d62f791d175cf6e99ec5e6586f43d97be894c4d7e06e"
...
<Warning>
  이 페이지는 팀 리서치를 위한 비공식 한글 번역입니다. 기술적 판단에는 [공식 영어 원문](https://docs.canton.network/reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/identityproviderconfigservice/updateidentityproviderconfig.md)을 사용하세요.
</Warning>
