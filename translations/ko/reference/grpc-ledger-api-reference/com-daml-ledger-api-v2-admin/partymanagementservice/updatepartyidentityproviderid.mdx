...
source_id: "SRC-735EDFDD43"
source_path: "reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/partymanagementservice/updatepartyidentityproviderid"
source_commit: "5ce61f7ca8ec6ad9af3d5e19db3583588ba49d65"
source_sha256: "e0a3088098e9f070eac30d312181bae2efe4e3739237f2b5f223b520b8d811fb"
...
<Warning>
  이 페이지는 팀 리서치를 위한 비공식 한글 번역입니다. 기술적 판단에는 [공식 영어 원문](https://docs.canton.network/reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/partymanagementservice/updatepartyidentityproviderid.md)을 사용하세요.
</Warning>
