...
source_id: "SRC-50FF8D9F0F"
source_path: "reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/commandinspectionservice/getcommandstatus"
source_commit: "5ce61f7ca8ec6ad9af3d5e19db3583588ba49d65"
source_sha256: "b7a1f7674be3702008d7ce13116552ca812d0ab0b48a88c1c6df01603a175d09"
...
<Warning>
  이 페이지는 팀 리서치를 위한 비공식 한글 번역입니다. 기술적 판단에는 [공식 영어 원문](https://docs.canton.network/reference/grpc-ledger-api-reference/com-daml-ledger-api-v2-admin/commandinspectionservice/getcommandstatus.md)을 사용하세요.
</Warning>
